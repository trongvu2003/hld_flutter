...
import '../presentation/views/auth/intro1_screen.dart';
import '../presentation/views/auth/intro_screen.dart';
import '../presentation/views/auth/signin_screen.dart';
import '../presentation/views/auth/signup_screen.dart';
import '../presentation/views/auth/start_screen.dart';
import '../presentation/views/user/booking/appointment_detail_screen.dart';
import '../presentation/views/user/booking/appointment_list_screen.dart';
import '../presentation/views/user/booking/booking_calendar_screen.dart';
import '../presentation/views/user/booking/confirm_booking_screen.dart';
import '../presentation/views/user/booking/service_selection_screen.dart';
import '../presentation/views/user/home/BMIchecking/bmi_checker_screen.dart';
import '../presentation/views/user/home/doctor/doctor_list_screen.dart';
import '../presentation/views/user/home/doctor/doctor_profile.dart';
import '../presentation/views/user/home/doctor/manage_clinic.dart';
import '../presentation/views/user/home/doctor/registerclinic.dart';
import '../presentation/views/user/home/home_screen.dart';
import '../presentation/views/user/home/personal/edit_option_page.dart';
import '../presentation/views/user/home/personal/edit_user_profile.dart';
import '../presentation/views/user/home/personal/otheruserprofile.dart';
import '../presentation/views/user/home/personal/setting_page.dart';
import '../presentation/views/user/home/personal/use_owner_profile.dart';
import '../presentation/views/user/main_screen.dart';
import '../presentation/views/user/home/post/create_post_screen.dart';
import '../presentation/views/user/home/post/postdetailscreen.dart';
